...
# set a URL for cloud run service
# ex: https://mixpanel-phish-lmozz6xkha-uc.a.run.app
CLOUD_RUN_SERVICE_URL=""

if [ -z "$CLOUD_RUN_SERVICE_URL" ]; then
	echo "Error: CLOUD_RUN_SERVICE_URL is not set"
	exit 1
fi
...
JWT_PAYLOAD=$(echo -n '{
    ...
    "target_audience": "'$CLOUD_RUN_SERVICE_URL'",
    "exp": '$EXPIRATION',
    "iat": '$NOW'
}' | base64url_encode)
